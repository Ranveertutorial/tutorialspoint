<head>
    ...
    <title>Tutorialspoints| Assignment help| Home work help</title>
                        ...
                        <ul class=" navigation-box">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="team-details.php">Teachers Details</a></li>
                                    <li><a href="become-teacher.php">Become Teacher</a></li>
                                </ul><!-- /.sub-menu -->
                            </li>
                            <li>
